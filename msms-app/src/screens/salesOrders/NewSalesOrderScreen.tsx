...
export default function NewSalesOrderScreen() {
  ...
  function handleProductChange(key: string, product: Product) {
    updateLine(key, { product, unitPrice: String(product.salePrice) });
  }
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      <ScrollView contentContainerStyle={styles.form} keyboardShouldPersistTaps="handled">
        ...
        <Input
          ...
          value={deliveryDate}
          onChangeText={(v) => setDeliveryDate(formatDateInput(v))}
        ...
        <Button label="Create Sales Order" onPress={handleSubmit} loading={loading} style={{ marginTop: 8 }} />
